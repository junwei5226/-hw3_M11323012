...
Original file is located at
    https://colab.research.google.com/drive/1cGCgMYmup9VoZtNzrFWBY_imJNI0GUZF
"""
...
# 建立結果目錄
!mkdir -p /content/results/fold2

# 請先將Fold2從本地上傳到Colab
print("請上傳Fold2資料夾的ZIP檔案...")
uploaded = files.upload()  # 上傳Fold2壓縮檔
...
checkpoint = ModelCheckpoint(
    '/content/results/fold2/best_model.h5',
...
tensorboard = TensorBoard(
    log_dir='/content/results/fold2/logs',
    write_images=True
)
...
results_df.to_csv('/content/results/fold2/metrics.csv', index=False)
print("測試集評估結果:")
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Validation'], loc='upper left')
plt.savefig('/content/results/fold2/training_history.png')
plt.show()
...
def visualize_results(images, masks, predictions, num_samples=5):
    ...
    plt.tight_layout()
    plt.savefig('/content/results/fold2/predictions.png')
    plt.show()
...
# 壓縮並下載結果
!zip -r /content/fold2_results.zip /content/results/fold2
files.download('/content/fold2_results.zip')
