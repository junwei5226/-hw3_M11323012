...
Original file is located at
    https://colab.research.google.com/drive/1VHB5_GJTMtsYa4gCXEmOv0MBvZ6V4CrW
"""
...
# 建立結果目錄
!mkdir -p /content/results/fold5

# 將Fold5從本地上傳到Colab
print("請上傳Fold5資料夾的ZIP檔案...")
uploaded = files.upload()  # 上傳Fold5壓縮檔
...
# 檢查目錄結構
print("檢查Fold5目錄結構...")
if os.path.exists('/content/Fold5'):
    print("Fold5目錄內容:", os.listdir('/content/Fold5'))
else:
    print("找不到Fold5目錄，請確認解壓縮是否成功")

# 設定資料路徑
data_path = '/content/Fold5'
...
checkpoint = ModelCheckpoint(
    '/content/results/fold5/best_model.h5',
...
tensorboard = TensorBoard(
    log_dir='/content/results/fold5/logs',
    write_images=True
)
...
results_df.to_csv('/content/results/fold5/metrics.csv', index=False)
print("測試集評估結果:")
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Validation'], loc='upper left')
plt.savefig('/content/results/fold5/training_history.png')
plt.show()
...
def visualize_results(images, masks, predictions, num_samples=5):
    ...
    plt.tight_layout()
    plt.savefig('/content/results/fold5/predictions.png')
    plt.show()
...
# 壓縮並下載結果
!zip -r /content/fold5_results.zip /content/results/fold5
files.download('/content/fold5_results.zip')
